...
if(TRUE)
    ...
    set(QMAKE_QWK_WIDGETFRAME_NAME_RELEASE QWKWidgetFrame)
    ...
    set(QMAKE_QWK_WIDGETFRAME_NAME_DEBUG QWKWidgetFrame${CMAKE_DEBUG_POSTFIX})
    ...
    if(QWINDOWKIT_BUILD_STATIC)
        ...
        set(QMAKE_QWK_WIDGETFRAME_STATIC_MACRO "DEFINES += QWK_WIDGETFRAME_STATIC")
    endif()
...
if(MSVC)
    ...
    if(QWINDOWKIT_BUILD_STATIC)
        set(MSBUILD_QWK_STATIC_MACRO 
            "<PreprocessorDefinitions>QWK_CORE_STATIC;QWK_WIDGETS_STATIC;QWK_QUICK_STATIC;QWK_WIDGETFRAME_STATIC</PreprocessorDefinitions>"
        )
    endif()
